package com.example.sockettestclient.util;

import android.content.Context;
import android.content.Intent;
import android.util.Log;

import com.example.sockettestclient.DialogActivity;
import com.example.sockettestclient.TestApplication;
import com.example.sockettestclient.objects.Header;
import com.example.sockettestclient.objects.Response;
...
public class ConnectionThread extends Thread{
    ...
    public void connectServer(User user){
        try {
            //Socket IP와 Port 설정.
            if(socket == null){
                socket = new Socket("192.168.219.107", 3333);
